...
public enum FontType: String {
    ...
    case PingFangSCMedium = "PingFang-SC-Medium"
    case PingFangSCBold = "PingFang-SC-Bold"
}
...
//    }
    ...
    //UI主要字体样式
    /// EZSwiftExtensions
    public class func PingFangSCRegularOFSize(size: CGFloat) -> UIFont {
        return JTFont(type: .PingFangSCRegular, size: size)
    }
    public class func PingfangSCMediumOFSize(size: CGFloat) -> UIFont {
        return JTFont(type: .PingFangSCMedium, size: size)
    }
    public class func PingFangSCBoldOFSize(size: CGFloat) -> UIFont {
        return JTFont(type: .PingFangSCBold, size: size)
    }

    public class func JTFont(type: FontType, size: CGFloat) -> UIFont! {
      //Using type
